...
There are two straight-forward ways of doing this involving the *absolute path* to the file on your computer. This figure illustrates the logic the hierachical file structure on a computer and how the file path results from it.
