...
# *R* as an Oversized Calculator{.tabset}
...
You could actually accomplish almost everything you need for your research without writing any scripts — simply type the commands in the *console* one at a time. However, it makes usually more sense to write your code into the script window, which results in a text file (called a script) with extension ```.R```. In this way, you can
...
We first explore simple operations, assignments, and data types to get familiar with the *R*. If you work in the console, then a "greater than sign" (>) at the **beginning of the line in the console** means that *R* is ready to accept your input.
