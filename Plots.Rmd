...
The plotting command ```matplot(x, y, ...)``` in R is an easy way to superimpose several data series. Here, *x* is a vector containing the values for the x-axes and *y* is a matrix containing the data that as a function of *x*. 
...
The most common application is to plot data that are stored in different columns of a matrix.
